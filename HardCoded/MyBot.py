...
def turns_to_get_to(game, me, node):
    return (7-me.speed) * len(game.shortest_paths(me.location, node)[0])
...
def will_kill_monster_before_move(me, monster):
    time_before_move = me.movement_counter - me.speed
    if monster.stance == "Rock":
        return time_before_move > monster.health/me.paper
    elif monster.stance == "Paper":
        return time_before_move > monster.health/me.scissors
    else:
        return time_before_move > monster.health/me.rock
