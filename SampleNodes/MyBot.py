...
# DO NOT CHANGE ABOVE ---------------------------
    ...
    for monster in game.monsters:
        drops = {"Rock": monster.death_effects.rock, "Paper": monster.death_effects.paper,
                 "Scissors": monster.death_effects.scissors, "Speed": monster.death_effects.speed,
                 "Health": monster.death_effects.health}
        game.log("Node: {0}, Drops: {1}".format(monster.location, drops))
